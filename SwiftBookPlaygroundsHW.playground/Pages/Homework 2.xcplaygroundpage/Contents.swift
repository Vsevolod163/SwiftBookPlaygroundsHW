...
let resultSum = Double(numberPi + secondNumber)

print("Первый вариант = \(resultSum)")
print()
...
var myAgeInDays = (nowYear - yearOfBirth) * daysInYear
myAgeInDays += (nowMonth - monthOfBirth) * daysInMonth
myAgeInDays += nowDay - dayOfBirth

let myAgeInMonth = myAgeInDays / daysInMonth
let myAgeInYears = myAgeInDays / daysInYear
let myAgeInSeconds = myAgeInDays * secondsInDay

print("\(myAgeInYears) years, \(myAgeInMonth) months, \(myAgeInDays) days and \(myAgeInSeconds) seconds\n")

if monthOfBirth > 0 && monthOfBirth <= 3 {
    print("Я родился в первом квартале \(yearOfBirth) года")
} else if monthOfBirth <= 6 {
    print("Я родился во втором квартале \(yearOfBirth) года")
} else if monthOfBirth <= 9 {
    print("Я родился в третьем квартале \(yearOfBirth) года")
} else {
    print("Я родился в четвертом квартале \(yearOfBirth) годв")
}
...
let sinus = sin(1.0)
let roundResult = round(sinus * 1000) / 1000

print("Результат = \(roundResult)")
